...
import { createNewProduct, deleteProductPost, deleteProductDelete, getNewProduct, getProducts, getUpdateProduct, updateProduct, getOrders, updateOrder } from '../controllers/admin.controller';
